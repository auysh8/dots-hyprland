    ...
    Column {
        ...
        Section {
            ConfigSwitch {
                ...
                StyledToolTip {
                    text: Translation.tr("Dims screen content as needed.\n\nPros: Immediately responsive\nCons: Expensive and can hurt color accuracy\n\nUses a Hyprland screen shader")
                }
            }
            ...
            ConfigSwitch {
                ...
                StyledToolTip {
                    text: Translation.tr("Adapts the display (physical screen) brightness\n\nPros: Less expensive, retains colors\nCons: Not immediately responsive\n\nAdjusts display brightness after each Hyprland IPC event")
                }
            }
        }
