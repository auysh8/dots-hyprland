...
Item {
    ...
    readonly property bool inViewport: layoutReady && viewportHeight > 0 && contentTop + height > viewportContentY && contentTop < viewportContentY + viewportHeight
    readonly property bool thresholdCrossed: activationEnabled && inViewport && contentTop + revealDepth <= viewportContentY + viewportHeight
    ...
    readonly property bool nearViewport: viewportHeight <= 0 || (contentTop + height >= viewportContentY - viewportOverscan
                                                                 && contentTop <= viewportContentY + viewportHeight + viewportOverscan)
    ...
    property bool slideAnimationEnabled: true
