...
WeatherInsightCard {
    ...
    readonly property color cardInk: Appearance.colors.colOnSurface
    readonly property color titleInk: Appearance.colors.colOnSurfaceVariant ?? Appearance.m3colors.m3onSurfaceVariant
