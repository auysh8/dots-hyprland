...
AbstractBackgroundWidget {
    ...
    property string localCityName: (Weather.data && Weather.data.city) ? Weather.data.city : "..."
            ...
            RowLayout {
                ...
                Repeater {
                    ...
                    delegate: AndroidClock {
                        ...
                        property bool isDay: (cityData && cityData.isDay !== undefined) ? cityData.isDay : true
                        backgroundColor: isDay ? Appearance.colors.colPrimary : Appearance.colors.colPrimaryContainer
                        handColor: isDay ? Appearance.colors.colOnPrimary : Appearance.colors.colOnLayer0
                        centerDotColor: isDay ? Appearance.colors.colOnPrimary : Appearance.colors.colOnLayer0
                        label: (cityData && cityData.name) ? cityData.name : ""
                        labelColor: Qt.rgba(
                            (isDay ? Appearance.colors.colOnPrimary : Appearance.colors.colOnLayer0).r,
                            (isDay ? Appearance.colors.colOnPrimary : Appearance.colors.colOnLayer0).g,
                            (isDay ? Appearance.colors.colOnPrimary : Appearance.colors.colOnLayer0).b,
                            0.75)
                        labelSpacing: 6
                        autoTime:    false
                        hourAngle: {
                            if (!cityData || !cityData.time) return 0
