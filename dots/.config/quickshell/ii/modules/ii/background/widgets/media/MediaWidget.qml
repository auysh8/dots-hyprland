...
AbstractBackgroundWidget {
    ...
    readonly property real mediaProgress: {
        const pos = (root.currentPlayer && root.currentPlayer.position !== undefined) ? root.currentPlayer.position : 0
        const len = (root.currentPlayer && root.currentPlayer.length !== undefined) ? root.currentPlayer.length : 0
            ...
            Item {
                ...
                RowLayout {
                    ...
                    RippleButton {
                        implicitWidth: 26
                        implicitHeight: 26
                        buttonRadius: (Appearance.rounding ? Appearance.rounding.full : 999)
                        colBackground: "transparent"
                        colBackgroundHover: ColorUtils.transparentize("#ffffff", 0.8)
                        colRipple: ColorUtils.transparentize("#ffffff", 0.7)
                        downAction: () => (root.currentPlayer ? root.currentPlayer.previous() : null)
                    ...
                    MaterialShapeWrappedMaterialSymbol {
                        ...
                        text: (root.currentPlayer && root.currentPlayer.isPlaying) ? "pause" : "play_arrow"
                        iconSize: 18
                        fill: 1
                        padding: 6
                    ...
                    RippleButton {
                        ...
                        colBackgroundHover: ColorUtils.transparentize("#ffffff", 0.8)
                        colRipple: ColorUtils.transparentize("#ffffff", 0.7)
                        downAction: () => (root.currentPlayer ? root.currentPlayer.next() : null)
            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    ColumnLayout {
                        ...
                        StyledText {
                            Layout.fillWidth: true
                            text: (root.currentPlayer && root.currentPlayer.trackArtist ? root.currentPlayer.trackArtist : "Play")
                        ...
                        StyledText {
                            Layout.fillWidth: true
                            text: (root.currentPlayer && root.currentPlayer.trackTitle ? root.currentPlayer.trackTitle : Translation.tr("Something"))
                ...
                Item {
                    ...
                    ColumnLayout {
                        ...
                        Rectangle {
                            ...
                            radius: (Appearance.rounding ? Appearance.rounding.full : 999)
                            ...
                            RowLayout {
                                ...
                                RippleButton {
                                    ...
                                    colRipple: Appearance.colors.colPrimaryContainerActive
                                    downAction: () => (root.currentPlayer ? root.currentPlayer.next() : null)
                                    altAction: () => (root.currentPlayer ? root.currentPlayer.previous() : null)
                ...
                Rectangle {
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            Layout.alignment: Qt.AlignVCenter
                            color: Appearance.colors.colPrimaryContainer
                            radius: (Appearance.rounding ? Appearance.rounding.normal : 12)
                            clip: true
                            layer.enabled: true
                            layer.effect: OpacityMask {
                                maskSource: Rectangle {
                                ...
                                MouseArea {
                                    ...
                                    onClicked: (mouse) => {
                                        if (mouse.button === Qt.RightButton) {
                                            if (root.currentPlayer) root.currentPlayer.next()
                                        } else {
