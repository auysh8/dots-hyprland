...
AbstractBackgroundWidget {
    ...
    Rectangle {
        ...
        radius: (Appearance.rounding ? Appearance.rounding.verylarge : 30)
        ...
        Component {
            ...
            ColumnLayout {
                ...
                StyledText {
                    text: (Weather.data && Weather.data.temp !== undefined) ? Weather.data.temp : "--°"
                ...
                StyledText {
                    ...
                    text: (Weather.data && Weather.data.city !== undefined) ? Weather.data.city : "--"
        ...
        Component {
            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    StyledText {
                        Layout.fillWidth: true
                        text: (Weather.data && Weather.data.description !== undefined) ? Weather.data.description : "--"
                    ...
                    RowLayout {
                        ...
                        StyledText {
                            text: (Weather.data && Weather.data.humidity !== undefined ? Weather.data.humidity : "--")
                            font.pixelSize: Appearance.font.pixelSize.smaller
                            color: Appearance.colors.colOnPrimaryContainer
                            opacity: 0.6
                        }
                        ...
                        StyledText {
                            text: (Weather.data && Weather.data.wind !== undefined ? Weather.data.wind : "--")
                            font.pixelSize: Appearance.font.pixelSize.smaller
                            color: Appearance.colors.colOnPrimaryContainer
                            opacity: 0.6
                        }
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    RowLayout {
                        ...
                        StyledText {
                            text: (Weather.data && Weather.data.cr !== undefined ? Weather.data.cr : "--")
                            font.pixelSize: Appearance.font.pixelSize.smaller
                            color: Appearance.colors.colOnPrimaryContainer
                            opacity: 0.6
                        }
                    ...
                    RowLayout {
                        ...
                        StyledText {
                            text: (Weather.data && Weather.data.visib !== undefined ? Weather.data.visib : "--")
                            font.pixelSize: Appearance.font.pixelSize.smaller
                            color: Appearance.colors.colOnPrimaryContainer
                            opacity: 0.6
                        }
                    ...
                    ColumnLayout{
                        ...
                        RowLayout {
                            ...
                            StyledText {
                                text: (Weather.data && Weather.data.sunrise !== undefined ? Weather.data.sunrise : "--")
                                font.pixelSize: Appearance.font.pixelSize.smaller
                                color: Appearance.colors.colOnPrimaryContainer
                                opacity: 0.6
                            }
                        ...
                        RowLayout {
                            ...
                            StyledText {
                                text: (Weather.data && Weather.data.sunset !== undefined ? Weather.data.sunset : "--")
                                font.pixelSize: Appearance.font.pixelSize.smaller
                                color: Appearance.colors.colOnPrimaryContainer
                                opacity: 0.6
                            }
            ...
            ColumnLayout {
                ...
                GridLayout {
                    ...
                    Rectangle {
                        Layout.fillWidth: true
                        Layout.fillHeight: true
                        radius: (Appearance.rounding ? Appearance.rounding.large : 20)
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            StyledText {
                                Layout.alignment: Qt.AlignHCenter
                                text: (Weather.data && Weather.data.tempFeelsLike !== undefined ? Weather.data.tempFeelsLike : "--")
                                font.pixelSize: Appearance.font.pixelSize.small
                                font.weight: Font.DemiBold
                                color: Appearance.colors.colOnSecondaryContainer
                            }
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            StyledText {
                                Layout.alignment: Qt.AlignHCenter
                                text: (Weather.data && Weather.data.precip !== undefined ? Weather.data.precip : "--")
                                font.pixelSize: Appearance.font.pixelSize.small
                                font.weight: Font.DemiBold
                                color: Appearance.colors.colOnSecondaryContainer
                            }
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            StyledText {
                                Layout.alignment: Qt.AlignHCenter
                                text: (Weather.data && Weather.data.press !== undefined ? Weather.data.press : "--")
                                font.pixelSize: Appearance.font.pixelSize.small
                                font.weight: Font.DemiBold
                                color: Appearance.colors.colOnSecondaryContainer
                            }
