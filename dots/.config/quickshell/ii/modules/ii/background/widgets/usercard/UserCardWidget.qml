...
AbstractBackgroundWidget {
    ...
    function weatherQuip() {
        ...
        const temp = (Weather.data && Weather.data.temp !== undefined) ? Weather.data.temp : "--";
        ...
        if (desc.includes("snow"))
            return { text: `• cold outside, stay warm`, icon: "ac_unit" };
        if (temp !== "--")
            return { text: `• ${temp}° outside right now`, icon: "thermostat" };
        return { text: `• hello there!`, icon: "waving_hand" };
    }
                    ...
                    Item {
                        ...
                        layer.effect: OpacityMask {
                            maskSource: Rectangle {
                                ...
                                radius: ((Appearance.rounding ? Appearance.rounding.verylarge : 30)) - 6
                            }
                        }
