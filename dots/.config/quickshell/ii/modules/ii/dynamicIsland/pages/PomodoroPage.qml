...
Item {
    ...
    readonly property color accentColor: isBreak 
        ? Appearance.colors.colSecondaryContainer 
        : Appearance.colors.colErrorContainer
        
    readonly property color onAccentColor: isBreak
    ...
    property int currentMaxDuration: {
        if (TimerService.pomodoroLongBreak) return longBreakDuration;
        if (TimerService.pomodoroBreak) return shortBreakDuration;
    ...
    Item {
        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                Text {
                    text: {
                        if (TimerService.pomodoroLongBreak) return "Long Break";
                        if (TimerService.pomodoroBreak) return "Short Break";
            ...
            Row {
                ...
                Repeater {
                    ...
                    Rectangle {
                        ...
                        color: completed ? root.accentColor
                             : current ? root.accentColor
                             : Qt.rgba(1,1,1,0.15)
                        
                        opacity: current ? 1.0 : (completed ? 0.6 : 1.0)
