...
Item {
    ...
    // Progress (0.0 -> 1.0)
    readonly property real progress: DownloadService.progress || 0.0
        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                Text {
                    ...
                    width: fontMetrics.advanceWidth("100%")
            ...
            Row {
                ...
                Text {
                    text: {
                        if (!DownloadService.active) return "PAUSED";
                        if (DownloadService.speed && DownloadService.speed !== "Unknown") return DownloadService.speed;
                        return "DOWNLOADING";
                    }
