    ...
    property var sections: [
        {
            ...
            subpages: [
                { name: Translation.tr("Quick settings"), icon: "instant_mix", component: "QuickConfig.qml" },
                { name: Translation.tr("General configuration"), icon: "browse", component: "GeneralConfig.qml" },
                { name: Translation.tr("Advanced settings"), icon: "construction", component: "AdvancedConfig.qml" }
            ]
        },
        {
            title: Translation.tr("Interface & style"),
            subpages: [
                { name: Translation.tr("Desktop bar"), icon: "toast", iconRotation: 180, component: "BarConfig.qml" },
                { name: Translation.tr("Wallpapers"), icon: "texture", component: "BackgroundConfig.qml" },
                { name: Translation.tr("Visual theme"), icon: "bottom_app_bar", component: "InterfaceConfig.qml" }
            ]
        },
        {
            title: Translation.tr("System management"),
            subpages: [
                { name: Translation.tr("Background services"), icon: "settings", component: "ServicesConfig.qml" },
                { name: Translation.tr("About shell"), icon: "info", component: "About.qml" }
            ]
        }
    ]

    property string currentComponent: "QuickConfig.qml"
