...
Singleton {
    ...
    property var timezones: (Config.options && Config.options.background && Config.options.background.widgets && Config.options.background.widgets.worldClock && Config.options.background.widgets.worldClock.timezones) ? Config.options.background.widgets.worldClock.timezones : [
    ...
    readonly property string ampmToken: {
        const fmt = (Config.options && Config.options.time && Config.options.time.format) ? Config.options.time.format : "HH:mm"
