    ...
    def get_stats(self) -> dict:
        ...
        with self._meta_lock:
            ...
            return {
                ...
                "total_size_mb": (art_size + audio_size + canvas_size) / 1024 / 1024,
                "max_size_mb": self.max_size_bytes / 1024 / 1024,
                "utilization": (art_size + audio_size + canvas_size) / self.max_size_bytes * 100,
            }
    ...
    def clear(self, clear_art: bool = True, clear_audio: bool = True):
        ...
        with self._meta_lock:
            to_remove = [
                ...
                if (clear_art and e["type"] == "art") or (clear_audio and e["type"] == "audio")
            ]
