...
if hl.plugin and hl.plugin.hyprglass then
    ...
    hg.layer("quickshell:bar",           {preset = "glass", mask_threshold = 0.7 })  -- top bar
    hg.layer("quickshell:dynamicIsland", {preset = "glass", mask_threshold = 0.7 })  -- dynamic island
    hg.layer("quickshell:verticalBar",   {preset = "glass", mask_threshold = 0.7 })  -- left icon bar
    hg.layer("quickshell:dock",          {preset = "glass", mask_threshold = 0.7 })  -- bottom dock
        -- hg.layer("quickshell:screenCorners", {preset = "glass", mask_threshold = 0.5 })  -- corner overlays

    -- ── Sidebars ──────────────────────────────────────────────────────
    hg.layer("quickshell:sidebarRight",  { preset = "glass", mask_threshold = 0.7 })  -- right sidebar
    hg.layer("quickshell:sidebarLeft",   {preset = "glass", mask_threshold = 0.7 })  -- left sidebar

    -- ── Popups & Overlays ─────────────────────────────────────────────
    -- hg.layer("quickshell:popup",              { preset = "glass", mask_threshold = 0.3 })  -- styled popups
    hg.layer("quickshell:notificationPopup",  {preset = "glass", mask_threshold = 0.7 })  -- notifications
    hg.layer("quickshell:onScreenDisplay",    {preset = "glass", mask_threshold = 0.7 })  -- OSD (vol/bright)
    hg.layer("quickshell:mediaControls",      {preset = "glass", mask_threshold = 0.7 })  -- media controls
    hg.layer("quickshell:overlay",            {preset = "glass", mask_threshold = 0.7 })  -- general overlay
    -- hg.layer("quickshell:reloadPopup",        {preset = "glass", mask_threshold = 0.3 })  -- reload popup
    hg.layer("quickshell:cheatsheet",         {preset = "glass", mask_threshold = 0.7 })  -- keybind sheet
    hg.layer("quickshell:desktopMenu",        {preset = "glass", mask_threshold = 0.7 })  -- general overlay
    hg.layer("quickshell:popup",        {preset = "glass", mask_threshold = 0.7 })  -- general overlay
    ...
    hg.layer("quickshell:osk",               {preset = "glass", mask_threshold = 0.7 })  -- on-screen keyboard
