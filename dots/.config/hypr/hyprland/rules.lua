...
hl.layer_rule({ match = { namespace = "quickshell:.*" }, ignore_alpha = 0.42})
...
hl.layer_rule({ match = { namespace = "quickshell:spotlight" }, animation = "fade"})
hl.layer_rule({ match = { namespace = "quickshell:app-drawer" }, animation = "slide bottom"})
hl.layer_rule({ match = { namespace = "quickshell:system-monitor" }, animation = "popin 90%"})
hl.layer_rule({ match = { namespace = "quickshell:notes" }, animation = "popin 90%"})
hl.layer_rule({ match = { namespace = "quickshell:settings" }, animation = "popin 90%"})
